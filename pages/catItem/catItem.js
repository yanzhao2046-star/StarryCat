...
/* 猫回信：猫把信拿走 3 秒后抵达（调试用短时长，正式可改为 3 天） */
const REPLY_DELAY = LETTER_TAKEN_MS + 3000
...
/* 9 个占位物品 */
const ITEMS = [
  { id: 'item_1', name: '物品 1', category: 'toys', symbol: '', icon: ICON_BASE + '1.svg' },
  { id: 'item_2', name: '物品 2', category: 'toys', symbol: '', icon: ICON_BASE + '2.svg' },
  { id: 'item_3', name: '物品 3', category: 'toys', symbol: '', icon: ICON_BASE + '3.svg' },
  { id: 'item_4', name: '物品 4', category: 'sports', symbol: '', icon: ICON_BASE + '4.svg' },
  { id: 'item_5', name: '物品 5', category: 'sports', symbol: '', icon: ICON_BASE + '5.svg' },
  { id: 'item_6', name: '物品 6', category: 'clothes', symbol: '', icon: ICON_BASE + '6.svg' },
  { id: 'item_7', name: '物品 7', category: 'clothes', symbol: '', icon: ICON_BASE + '7.svg' },
  { id: 'item_8', name: '物品 8', category: 'animals', symbol: '', icon: ICON_BASE + '8.svg' },
  { id: 'item_9', name: '物品 9', category: 'plants', symbol: '', icon: ICON_BASE + '9.svg' },
]
...
Page({
  ...
  _initLib() {
    try {
      if (!wx.getStorageSync(LIB_KEY)) wx.setStorageSync(LIB_KEY, ITEMS)
    } catch (e) {}
  },
